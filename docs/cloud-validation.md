...
The vendored SDK is built from Cloud integration source `679ea26dfa1d0aad8c449664beb1ece06ba78e85` in [Cloud PR #32105](https://github.com/elizaOS/eliza/pull/32105). It includes the current foundation billing-account API alongside generic app subscriptions, delegation, inference and notifications. Typed operations continue to require JSON results and reject empty HTTP 204/205 responses. The generated route catalog excludes retired product-specific endpoints. The adjacent vendor manifest records source and artifact hashes. This local release candidate does not establish deployed API availability.
